                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text"  id="customer" readonly name="" value="{{$salesOrder->customer->code}}-{{$salesOrder->customer->name}}" class="form-control" placeholder="-">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" readonly id="term_of_payment" required name="" value="{{$salesOrder->paymentTerm->code}} {{$salesOrder->paymentTerm->name}}" class="form-control" placeholder="-">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" readonly id="delivery_type" required name="" value="{{$salesOrder->delivery->name}}"  class="form-control" placeholder="-">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text"  value="{{$salesOrder->currency->symbol}}"  readonly id="currency" required class="form-control" placeholder="-">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" readonly value="{{$salesOrder->salesman->name}}" id="salesman" required class="form-control" placeholder="-">
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" readonly rows="6">{{$salesOrder->customer->getCustomerDetail->address}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
