...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('salesReturn.insert') !!}</a>
            </li>
        </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="customer_id" style="width: 100%"  id="purchaseSpId" class="form-control select2">
                                        <option value="0" id="default">-----</option>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $(".btnSaveProduct").click(function(){
                var urls='{{route('salesReturn.addData')}}';
                if(form.valid()) {
                    $.ajax({
                        url: urls,
                        type: 'POST',
