...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('insert.purchaseOrder') !!}</a>
            </li>
        </ul>
            ...
            <div class="portlet box">
                <div class="portlet-body">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-8">
                                <span style="font-size: 24px;">Create Purchase Order</span>
                            </div>
                            <div class="col-md-4">
                                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <input type="text" name="sales_order_no" readonly value="{{$code}}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="salesman" required class="form-control" placeholder="-">
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $(".btnSaveProduct").click(function(){
                var urls='{{route('purchaseOrder.addData')}}';
                if(form.valid()) {
                    $.ajax({
                        url: urls,
                        type: 'POST',
