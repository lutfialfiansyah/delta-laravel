...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('edit.purchaseOrder') !!}</a>
            </li>
        </ul>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="purchase_order_no" value="{{$purchaseOrder->purchase_order_no}}" readonly class="form-control">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="date" required name="date" value="{{$purchaseOrder->date}}" class="form-control" placeholder="-">
                                ...
                                <div class="form-group">
                                    ...
                                    <select  required class="form-control select2" id="branch" style="width:100%" name="branch">
                                        ...
                                        @foreach($branch as $row)
                                            <option {{{($purchaseOrder->branch_id==$row->id)?'selected':''}}} value="{{$row->id}}">{{$row->description}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="portlet-body form">
                    <table class="table table-hover table-bordered" id="tabledetail">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><span id="sumtotal">Rp. {{ number_format($purchaseOrder->total)}}</span></td>
                        </tr>
                        </tfoot>
                    </table>
        ...
        <div class="modal-dialog cascading-modal" rule="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="sumtotal" id="tsumtotal" value="{{$purchaseOrder->total}}" >
                    <input type="hidden" name="idpo" value="{{$purchaseOrder->id}}" >
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".btnSaveProduct").click(function () {
                $.post("{{ route('purchaseOrder.updateProduct',$purchaseOrder->id)}}",{sumtotal:$("#tsumtotal").val()},function(data){
                    console.log(data)
                     swal({
