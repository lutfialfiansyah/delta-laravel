                                            ...
                                            <div class="row" style="margin-top:15px">
                                                <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-10">
                                                            <input type="text" name="code" value="{{$promotion->code}}" class="form-control">
                                                          </div>
                                                      </div>
                                                </div>
                                                <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-8">
                                                            <input type="text" name="description" value="{{$promotion->description}}" class="form-control">
                                                          </div>
                                                      </div>
                                                </div>
                                                <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-8">
                                                            <input type="text" name="time_start" value="{{$promotion->time_start}}" class="form-control date">
                                                          </div>
                                                      </div>
                                                </div>
                                                <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-8">
                                                            <input type="text" name="time_end" value="{{$promotion->time_end}}" class="form-control date">
                                                          </div>
                                                      </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-top:15px">
                                                <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-10">
                                                            <input type="text" name="qty" value="{{$promotion->qty}}" class="form-control">
                                                          </div>
                                                      </div>
                                                </div>
                                                <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-8">
                                                            ...
                                                            <input name="unit_id" type="hidden"  style="width: 100%" value={{$promotion->unit_id}}  id="unit_id" class="form-control">
                                                            <span class="input-group-addon"  id="sunit" style="    cursor: pointer;" ><i class="fa fa-search"></i></span>
                                                            <input name=""  style="width: 100%" value="{{$promotion->unit->name}}"  id="unit" class="form-control">
                                                          </div>
                                                          </div>
                                                      </div>
                                                </div>
                                                <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-6">
                                                            <input type="text" name="disc" value="{{$promotion->disc1}}" class="form-control">
                                                          </div>
                                                          %
                                                      </div>
                                                </div>
                                                <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-sm-6">
                                                            <input type="text" name="disc2" value="{{$promotion->disc2}}" class="form-control">
                                                          </div>
                                                          %
                                                      </div>
                                                </div>
                                                    ...
                                                    <table class="table table-hover table-bordered" id="table-product">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          @foreach($product as $row)
                                                            <tr>
                                                                <td><input type="hidden" name="product_id[]" value="{{$row->id}}">{{$row->name}}</td>
                                                                <td><button type='button' style='float:right' data-index='{{$a}}' class='btn btn-danger deleteProduct'><i class='icon-trash'></i></button></td>
                                                            </tr>
                                                            @php
                                                              $a++;
                                                            @endphp
                                                  ...
                                                  <table class="table table-hover table-bordered" id="table-brand">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        @foreach($brand as $row)
                                                          <tr>
                                                              <td><input type="hidden" name="branch_id[]" value="{{$row->id}}">{{$row->name}}</td>
                                                              <td><button type='button' style='float:right' data-index='{{$a}}' class='btn btn-danger deleteProduct'><i class='icon-trash'></i></button></td>
                                                          </tr>
                                                          @php
                                                            $a++;
                                            ...
                                            <table class="table table-hover table-bordered" id="table-category">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($category as $row)
                                                    <tr>
                                                        <td><input type="hidden" name="category_id[]" value="{{$row->id}}">{{$row->name}}</td>
                                                        <td><button type='button' style='float:right' data-index='{{$a}}' class='btn btn-danger deleteProduct'><i class='icon-trash'></i></button></td>
                                                    </tr>
                                                    @php
                                                      $a++;
                                            ...
                                            <table class="table table-hover table-bordered" id="table-subcat">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($subcategory as $row)
                                                    <tr>
                                                        <td><input type="hidden" name="subcategory_id[]" value="{{$row->id}}">{{$row->name}}</td>
                                                        <td><button type='button' style='float:right' data-index='{{$a}}' class='btn btn-danger deleteProduct'><i class='icon-trash'></i></button></td>
                                                    </tr>
                                                    @php
                                                      $a++;
                                          ...
                                          <div class="portlet-body">
                                            <table class="table table-hover table-bordered" id="table-type">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($type as $row)
                                                    <tr>
                                                        <td><input type="hidden" name="type_id[]" value="{{$row->id}}">{{$row->name}}</td>
                                                        <td><button type='button' style='float:right' data-index='{{$a}}' class='btn btn-danger deleteProduct'><i class='icon-trash'></i></button></td>
                                                    </tr>
                                                    @php
                                                      $a++;
                                            ...
                                            <table class="table table-hover table-bordered" id="table-group">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($group as $row)
                                                    <tr>
                                                        <td><input type="hidden" name="group_id[]" value="{{$row->id}}">{{$row->name}}</td>
                                                        <td><button type='button' style='float:right' data-index='{{$a}}' class='btn btn-danger deleteProduct'><i class='icon-trash'></i></button></td>
                                                    </tr>
                                                    @php
                                                      $a++;
...
margin-top: -39px;">
                                              ...
                                              <table class="table table-hover table-bordered" id="table-customer_group">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    @foreach($customer_group as $row)
                                                      <tr>
                                                          <td><input type="hidden" name="customer_group_id[]" value="{{$row->id}}">{{$row->name}}</td>
                                                          <td><button type='button' style='float:right' data-index='{{$a}}' class='btn btn-danger deleteProduct'><i class='icon-trash'></i></button></td>
                                                      </tr>
                                                      @php
                                                        $a++;
  ...
  $(function(){
    ...
    $(".btnSaveProduct").click(function(){
        var urls='{{route('promotion.update',$promotion->id)}}';
        if(form.valid()) {
            $.ajax({
                url: urls,
                type: 'POST',
    ...
    $( "#brand" ).autocomplete(
        ...
        $("#sbrand").click(function () {
          ...
          $( "#tcategory" ).on( "autocompleteselect", function( event, ui ) {
            $('#category_id').val(ui.item.id).trigger('change')
