                    ...
                    <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="twerehouse" class="form-control">
                                                <input type="hidden" name="werehouse_id" id="werehouse" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="vendor" required name="" value="" class="form-control" placeholder="-">
                                                <input type="hidden" id="vendor_id" required name="vendor_id" value="" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="term_of_payment" required name="" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" id="sales_order_id" required name="sales_order_id" value="" class="form-control" placeholder="-">
                                                <input type="text" id="sales_order" required name="" value="" class="form-control" placeholder="-">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="name">Vendor Invoice No. </label>
                                        ...
                                        <div class="row" style="margin-top:10px">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" value="Rp. " class="form-control">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="text" id="lprice" class="form-control">
                                        ...
                                        <div class="row" style="margin-top:10px">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" id="" value="Rp." class="form-control">
                                                    </div>
                                                    <div class="col-sm-4">
    ...
    <script type="text/javascript">
        $(function(){
          ...
          $('#lprice').change(function(){
            ...
            $( "#purchase_order_id" ).on( "autocompleteselect", function( event, ui ) {
                $('#purchaseOrderId').val(ui.item.id).trigger('change')
            })
            $( "#vendor" ).on( "autocompleteselect", function( event, ui ) {
                $('#vendor_id').val(ui.item.id).trigger('change')
            })
            $( "#sales_order" ).on( "autocompleteselect", function( event, ui ) {
                $('#sales_order_id').val(ui.item.id).trigger('change')
            })
            ...
            $(document).on("click", '.btnAddProduct',function(){
                ...
                var basic_unit = row.insertCell(6)
                ...
                qty.innerHTML = "<input class='qty' type='hidden' id='qty_"+count+"' name='qty[]' value='"+$("#qty").val()+"'><span id='lqty_"+count+"'>"+$("#qty").val()+"</span>"
                basic_unit.innerHTML = "<input class='' type='hidden' id='basic_unit_"+count+"' name='basic_unit[]' value='"+$("#totqty").val().split(" ")[0]+"'><span id='lqty_"+count+"'>"+$("#totqty").val().split(" ")[0]+"</span>"
                ...
                discount.innerHTML = "<input type='hidden' id='discount_"+count+"' name='discount[]' value='0'>0"
                ...
                $.get('{{url('api/purchaseOrder/getDetail/')}}/'+id,function(data){
                    ...
                    for(var i in data)
                    {
                        ...
                        valuetable = valuetable+"<tr>" +
                            ...
                            "<td><input class='qty' type='hidden' id='qty_"+count+"' name='qty[]' value='"+data[i].qty+"'><span id='lqty_"+count+"'>"+data[i].qty+"</span></td>"+
                            ...
                            "<td><input type='hidden' id='discount_"+count+"' name='discount[]' value='"+parseInt(data[i].discount)+"'><span id='ldisacount_"+count+"'>"+accounting.formatMoney(data[i].discount,'',2)+"</span></td>"+
                            "<td><input type='hidden'  id='rate_"+count+"' name='rate[]' value='10'><input type='hidden'  id='tax_"+count+"' name='taxid[]' value='"+data[i].tax_id+"'><input type='hidden' id='total_"+count+"' class='total' price='"+parseInt(data[i].total)+"' name='total[]' value='"+parseInt(data[i].total)+"'><span id='ltotal_"+count+"'>"+accounting.formatMoney(data[i].total,'',0)+"</span></td>"+
