                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="#mdlCustomerGroup" class="btn sbold green btn-circle btn-sm btnGroupdadd" data-toggle="modal" >Add New <i class="fa fa-plus"></i></a>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var oTable = $('#table-customergroup').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('vendorGroup.getData') }}",
            ...
            $(".btnall").click(function() {
                ...
                var urls="";
                if(dataid==0){
                    urls='{{route('vendorGroup.addData')}}';
                }else{
                    urls='{{url('api/vendorGroup/updateData')}}/'+dataid;
                }
                if(form.valid()) {
                    $.ajax({
                        url: urls,
