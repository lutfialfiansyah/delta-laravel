            ...
            <div class="portlet box ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> DN Transaction Table</span>
                    </div>
                    <div class="actions">
        ...
        <div class="modal-dialog modal-full">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">DN Transaction</h4>
                </div>
                            ...
                            <div style="height:250px">
                                ...
                                <div class="col-md-6">
                                    <table style="width:100%" class="table table-striped table-bordered table-hover table-checkable order-column table-stock2" id="table-sales_transaction">
                                        <thead>
                                        <tr>
                                            <td colspan="6">Purchase Transaction</td>
                                        </tr>
                                        <tr>
                                            <td>#</td>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('#productid').change(function(){
                    ...
                    var valuetable2 =""
                    $.get('{{url('api/dnTransaction/getDnTransactionById')}}/'+$(this).val(),function(data){
                        $.each(data.msg,function(index, value){
                ...
                var oTable = $('#table-stock').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "{{ route('dnTransaction.getData') }}",
                    ...
                    "columns": [
                        ...
                        {data: 'dn_transaction_no', name: 'name'},
                ...
                $(".btnall").click(function() {
                    ...
                    var urls="";
                    if(dataid==0){
                        urls='{{route('dnTransaction.addData')}}';
                    }else{
