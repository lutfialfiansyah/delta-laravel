...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('debitNote.type') !!}</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
            ...
            <div class="portlet box ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase"> DN Table</span>
                    </div>
                    <div class="actions">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">DN Type</h4>
                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var oTable = $('#table-group').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('debitNoteType.getData') }}",
                    ...
                    $("#table-group a.groupedit").click(function () {
                        ...
                        $("a.delete").click(function () {
                            ...
                            swal({
                                    ...
                                    if (isConfirm) {
                                        $.ajax({
                                            url: '{{url('api/debitNoteType/deleteData/')}}/'+id,
                                            type: 'GET',
                                            dataType: 'json',
            ...
            $(".btnall").click(function() {
                ...
                var urls="";
                if(dataid==0){
                    urls='{{route('debitNoteType.addData')}}';
                }else{
                    urls='{{url('api/debitNoteType/updateData')}}/' + dataid;
                }
                if(form.valid()) {
                    $.ajax({
                        url: urls,
