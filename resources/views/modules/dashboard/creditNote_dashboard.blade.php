            ...
            <div class="portlet box ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase"> Credit Note  Table</span>
                    </div>
                    <div class="actions">
                      <div class="row">
                          <div class="col-md-6">
                              <div class="btn-group">
                                  <a class="btn sbold green btnbrandadd"  data-toggle="modal" href="#mdlstock"> Add New
        ...
        <script type="text/javascript">
            $(function() {
                        ...
                        $("#table-stock a.stockedit").click(function () {
                            ...
                            $("a.delete").click(function () {
                                ...
                                swal({
                                        ...
                                        if (isConfirm) {
                                            $.ajax({
                                                url: '{{url('api/accountPayable/deleteData/')}}/'+id,
                                                type: 'GET',
                                                dataType: 'json',
                ...
                $(".btnall").click(function() {
                    ...
                    var urls="";
                    if(dataid==0){
                        urls='{{route('creditNote.addData')}}';
                    }else{
                        urls='{{url('api/accountPayable/updateData')}}/'+dataid;
                    }
                    if(form.valid()) {
                        $.ajax({
                            url: urls,
