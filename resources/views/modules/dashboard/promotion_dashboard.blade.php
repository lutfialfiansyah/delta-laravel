...
@section('content')
  ...
  <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('view.promotion') !!}</a>
            </li>
        </ul>
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase">Promotion</span>
                    </div>
                    <div class="actions">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    ...
                                    <a class="btn sbold green"  href="{{route('promotion.insert')}}">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <button class="btn tools dropdown-toggle" data-toggle="dropdown">Action
                                        <i class="fa fa-angle-down"></i>
                                    </button>
        ...
        $(function() {
            ...
            var oTable = $('#table-group').DataTable({
                ...
                "columns": [
                    ...
                    {data: 'disc1', name: 'disc1'},
                    {data: 'disc2', name: 'disc2'},
