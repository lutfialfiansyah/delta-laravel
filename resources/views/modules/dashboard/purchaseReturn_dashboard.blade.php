...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('view.purchaseReturn') !!}</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
            ...
            <div class="portlet box ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase"> purchase Return Table</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{url('/purchaseReturn/insert_purchaseReturn')}}" class="btn sbold green btn-circle btn-sm" >Add New <i class="fa fa-plus"></i></a>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var oTable = $('#table-group').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('purchaseReturn.getData') }}",
                ...
                "columns": [
                    ...
                    {data: 'purchase_return_no', name: 'name'},
                    {data: 'date', name: 'name'},
