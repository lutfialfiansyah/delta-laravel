...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('arPayment') !!}</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
            ...
            <div class="portlet box ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> AR Payment  Table</span>
                    </div>
                    <div class="actions">
