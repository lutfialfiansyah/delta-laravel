...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('accountPayable') !!}</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
            ...
            <div class="portlet box ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase"> AP  Table</span>
                    </div>
                    <div class="actions">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var oTable = $('#table-stock').DataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": "{{ route('accountPayable.getData') }}",
                ...
                $(".btnall").click(function() {
                    ...
                    var urls="";
                    if(dataid==0){
                        urls='{{route('accountPayable.addData')}}';
                    }else{
