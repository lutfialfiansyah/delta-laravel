            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase">Purchase Transaction</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{route('insert.purchase')}}" class="btn sbold green btn-circle btn-sm" >Add New <i class="fa fa-plus"></i></a>
        ...
        $(function() {
            ...
            var oTable = $('#table-group').DataTable({
                ...
                "columns": [
                    ...
                    {data: 'purchase_transaction_no', name: 'purchase_transaction_no'},
                    {data: 'date', name: 'date'},
                    {data: 'sub_total', name: 'sub_total'},
                    {data: 'additional_discount', name: 'additional_discount'},
            ...
            $.get('{{url('api/branch/getBranch')}}',function(data){
                ...
                $("div.branch").html('<label><select name="branch" id="sbranch"><option value="">All</option>'+branch+'</select></label>');
            });

            $(document).on("change", '#sbranch',function(){
                alert($(this).val())
