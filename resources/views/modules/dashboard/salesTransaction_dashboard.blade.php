...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('salesTransaction') !!}</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase"> Sales Transaction</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{url('/salesTransaction/insert')}}" class="btn sbold green btn-circle btn-sm" >Add New <i class="fa fa-plus"></i></a>
...
//                sScrollY: calcDataTableHeight(),
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('salesTransaction.getData') }}",
                ...
                "columns": [
                    ...
                    {data: 'date', name: 'name'},
                    {data: 'sales_transaction_no', name: 'name'},
                    {data: 'customerName', name: 'name'},
                    {data: 'sales_order_no', name: 'name'},
                    {data: 'sub_total', name: 'name'},
                    {data: 'other_discount', name: 'name'},
                    {data: 'other_cost', name: 'name'},
                    {data: 'grand_total', name: 'name'},
                    {data: 'tax_subtotal', name: 'name'},
                    {data: 'grand_total_w_tax', name: 'name'},
