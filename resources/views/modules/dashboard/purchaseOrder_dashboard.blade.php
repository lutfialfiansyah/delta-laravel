...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('view.purchaseOrder') !!}</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{url('/purchaseOrder/insert_purchaseOrder')}}" class="btn sbold green btn-circle btn-sm" >Add New <i class="fa fa-plus"></i></a>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var oTable = $('#table-group').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('purchaseOrder.getData') }}",
                ...
                "columns": [
                    ...
                    {data: 'date', name: 'name'},
                    {data: 'purchase_order_no', name: 'name'},
