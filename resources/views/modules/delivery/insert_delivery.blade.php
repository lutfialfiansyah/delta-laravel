...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                <a href="">{!! Breadcrumbs::render('insert.delivery') !!}</a>
            </li>
        </ul>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="code" required name="code" value="{{$code}}" readonly class="form-control" placeholder="B001">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('.btnsaveshipping').click(function () {
                var urls='{{route('delivery.addData')}}';
                if(form.valid()) {
                    $.ajax({
                        url: urls,
                        type: 'POST',
